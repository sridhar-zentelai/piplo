...
export default function HomeHero({ entries }: { entries: HistoryEntry[] }) {
  ...
  return (
    <section className="border-b border-border px-6 pb-6 pt-7">
      {/* The rule stays full width; the content inside it does not, so the hero
          does not sprawl when the window is maximised. */}
      <div className="mx-auto w-full max-w-3xl">
        <div className="flex items-start justify-between gap-6">
          <div className="flex min-w-0 items-center gap-4">
            <img src="/icon.png" alt="" className="size-12 shrink-0" />
