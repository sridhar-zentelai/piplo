...
/** Four items. Anything else belongs on the settings page — including undoing the
 *  last word fix, which is `Ctrl+Alt+Z` and wants to be used without moving the
 *  mouse away from the text in the first place. */
